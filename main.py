...
PHRASES = {
    ...
    'commendations': [
        ...
        'Хорошо справляется с нагрузкой, получаемый материал хорошо запоминается и может им пользоваться в последующих проектах.',
        ...
        'Хорошо справляется с нагрузкой, но иногда возникают трудности в понимании нового материала. Если материал разобрал, то остается в память и используется в будущем.',
        ...
        'Справляется чаще самостоятельно, но не очень любит искать ошибки с своем коде.',
        'Понимает что за чем следует и выстраивает связи между тем что необходимо сделать и что он может сделать.',
        'Хорошо ориентируется в документации. Читает ее не спеша и с полным пониманием. Легко усваивать новый материал.',
    ...
    'behaviour':[
        ...
        'Любит максимально упростить выполнение заданий - это является огромным плюсом для программиста.',
